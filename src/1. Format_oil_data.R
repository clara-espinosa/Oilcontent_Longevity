...
read.csv("data/oil_data.csv", sep= ";")%>%
  ...
  dplyr::select(Taxon,  family, community, oil.content, C12.0:C24.1n9) -> oil_data_pca
...
read.csv("data/oil_data.csv", sep= ";")%>%  
  ...
  dplyr::select(Taxon,  family, community, oil.content, ratio, UFA, SFA, C12.0:C24.1n9)-> oil_data_full
