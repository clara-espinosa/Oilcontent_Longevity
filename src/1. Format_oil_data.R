...
read.csv("data/oil_alpinedata.csv", sep= ",")%>%  
  ...
  dplyr::select(Taxon,  family, order, community, year_analisis, ecology, 
                oil.content, ratio, UFA, SFA, C12.0:C24.1n9)-> oil_alpine_data # data frame with all oil data together in wide format
